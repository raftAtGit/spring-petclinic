...
@ContextConfiguration({"classpath:spring/postvayler-config.xml", "classpath:spring/business-config.xml", "classpath:spring/tools-config.xml", "classpath:spring/mvc-core-config.xml"})
@WebAppConfiguration
